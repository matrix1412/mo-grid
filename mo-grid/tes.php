...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">MO-GRID</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="gateway.php"  aria-expanded="false" aria-controls="collapsePages">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">TEGANGAN</div>
        ...
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#grafik-tegangan").load("load/panel_1/grafik_tegangan.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#grafik-arus").load("load/panel_1/grafik_arus.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#grafik-daya").load("load/panel_1/grafik_daya.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#grafik-rssi").load("load/panel_1/grafik_rssi.php");
                }, 1000 );
              });
        </script>
        ...
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#cek-arus").load("load/panel_1/cek_arus.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#cek-daya").load("load/panel_1/cek_daya.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#cek-tegangan").load("load/panel_1/cek_tegangan.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#cek-rssi").load("load/panel_1/cek_rssi.php");
                }, 1000 );
              });
        </script>
    </body>
