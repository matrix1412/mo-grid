    ...
    <body class="sb-nav-fixed">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="container box">
                        <br>
                            <div class="table-responsive">
                                <div class="row">
                                 <form method="post" class="form-group" action="load/node_1/export_filter.php">
              ...
              <div class="modal-footer">
                <form method="post" action="load/node_1/export.php">  
        ...
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#grafik-tegangan").load("load/node_1/grafik_tegangan.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#grafik-arus").load("load/node_1/grafik_arus.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#grafik-daya").load("load/node_1/grafik_daya.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#grafik-rssi").load("load/node_1/grafik_rssi.php");
                }, 1000 );
              });
        </script>
        <!-- load data -->
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#cek-arus").load("load/node_1/cek_arus.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#cek-daya").load("load/node_1/cek_daya.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#cek-tegangan").load("load/node_1/cek_tegangan.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#cek-rssi").load("load/node_1/cek_rssi.php");
                }, 1000 );
              });
        </script>
    </body>
