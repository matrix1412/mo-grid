    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">
                                        ...
                                        <a class="medium text-white stretched-link" href="node_1.php"> Node 1</a></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <span id="cek-daya1">0</span>
                                            <span>V</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-info text-white mb-4">
                                    <div class="card-body"> 
                                        <i class="fas fa-solar-panel"></i>
                                        <a class="medium text-white stretched-link" href="node_2.php"> Node 2</a>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                         <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <span id="cek-daya2">0</span>
                                            <span>V</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">
                                        <i class="fas fa-solar-panel"></i>
                                        <a class="medium text-white stretched-link" href="node_3.php"> Node 3</a>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                       <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <span id="cek-daya3">0</span>
                                            <span>V</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 container-fluid">
                                <div class="card mb-4 card-primary">
                                    ...
                                    <div class="card-body">
                                        <div id="grafik-tegangan" width="100%" height="40"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="container box">
                        <br>
                            <div class="table-responsive">
                                <div class="row">
                                 <form method="post" class="form-group" action="load/panel_1/export_filter.php">
              ...
              <div class="modal-footer">
                <form method="post" action="load/panel_1/export.php">  
        ...
        <script type="text/javascript">
                $(document).ready( function(){
                  ...
                  setInterval( function(){
                    $("#cek-daya1").load("load/dashboard/cek_daya1.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#cek-daya2").load("load/dashboard/cek_daya2.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#cek-daya3").load("load/dashboard/cek_daya3.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#cek-delay").load("load/dashboard/cek_delay.php");
                }, 1000 );
              });
        </script>
        <!-- Load grafik -->
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#grafik-arus").load("load/dashboard/grafik_arus.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#grafik-tegangan").load("load/dashboard/grafik_tegangan.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#grafik-daya").load("load/dashboard/grafik_daya.php");
                }, 1000 );
              });
        </script>
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  setInterval(function(){
                    $("#grafik-delay").load("load/dashboard/grafik_delay.php");
                }, 1000 );
              });
        </script>
    </body>
